...
const pane = tv(
	{
		base: "relative block overflow-y-auto overflow-x-hidden rounded-md",
		variants: {
			variant: {
	...
	return (
		<>
			<div className="-ml-6 flex">
				...
				>
					<div className="group-focused:state-focus group-pressed:state-pressed group-pressed:w-3 group-pressed:h-13 group-pressed:bg-on-surface group-pressed:rounded-md h-12 w-1 rounded-full bg-outline text-inverse-on-surface transition-all duration-sm ease-emphasized-accelerate group-hover:state-hover"></div>
				</button>

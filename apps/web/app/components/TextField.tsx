...
function TextFieldFilledLabel(props: ComponentProps<"label">): ReactNode {
	return (
		<Label
			{...props}
			className={classes(
				"group-hover:on-surface text-body-sm text-on-surface-variant text-on-surface/[.38] group-focus-within:text-primary peer-placeholder-shown:text-body-lg peer-placeholder-shown:group-focus-within:text-body-sm group-error:text-error group-hover:group-error:text-on-error-container group-focus-within:group-hover:group-error:text-error peer-placeholder-shown:group-has-disabled:top-4 pointer-events-none absolute transition-all peer-placeholder-shown:top-4 ease-effects-fast duration-effects-fast",

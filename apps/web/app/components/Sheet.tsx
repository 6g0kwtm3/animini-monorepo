...
const sheet = tv(
	{
		slots: {
			root: "data-enter:transform-none fixed flex flex-col overflow-hidden bg-surface-container-low transition-transform duration-2sm ease-emphasized",
			backdrop: "",
			container:
		...
		variants: {
			...
			modal: {
				true: {
					backdrop:
						"data-enter:opacity-100 bg-scrim/40 opacity-0 transition-opacity duration-sm ease-emphasized",
				},
				false: {},
			},
		},

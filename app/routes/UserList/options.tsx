...
export const useAnimeStatusOptions = () =>
	({
...
export const useMangaStatusOptions = () =>
	({
		FINISHED: m.media_status_finished(),
		RELEASING: m.media_status_releasing(),
...
export const useAnimeFormatOptions = () =>
	({
...
export const useAnimeSortOptions = () => ({
...
export const useMangaSortOptions = () => ({
	...useAnimeSortOptions(),
})

export const useMangaFormatOptions = () =>
	({

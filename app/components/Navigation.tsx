		...
		variants: {
			...
			variant: {
				bar: {
					...
					icon: "relative flex h-8 w-16 items-center justify-center rounded-lg group-hover:state-hover group-aria-[current='page']:text-on-secondary-container *:first:group-aria-[current='page']:hidden *:last:group-aria-[current='page']:block group-focused:state-focus group-pressed:state-pressed",
				...
				drawer: {
					...
					icon: "h-6 w-6 group-hover:text-on-surface group-hover:state-none *:first:group-aria-[current='page']:block *:last:group-aria-[current='page']:hidden group-focused:text-on-surface group-focused:state-none group-pressed:text-on-surface group-pressed:state-none",

...
const sheet = tv(
	{
		...
		variants: {
			variant: {
				...
				side: {
					root: "bottom-0 end-0 top-0 my-0 me-0 ms-auto h-full max-h-full w-[25rem] max-w-[25rem] translate-x-full translate-y-0 rounded-l-xl rounded-r-none rtl:-translate-x-full",
				},
			},
			modal: {
				true: {

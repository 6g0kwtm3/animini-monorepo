	...
	variants: {
		variant: {
			...
			outlined: {
				...
				container: "",
				outline:
					"pointer-events-none absolute -top-[0.71875rem] bottom-0 end-0 start-0 rounded-xs border border-outline px-[0.625rem] transition-all group-has-[[aria-disabled='true']]:border-outline/[.12] group-hover:group-has-[[aria-disabled='true']]:border-outline/[.12] group-error:border-error group-hover:group-error:border-on-error-container group-has-read-write:group-hover:border-on-surface group-has-focused:group-error:border-error group-has-focused:group-hover:group-error:border-error group-has-read-write:group-has-focused:border-2 group-has-read-write:group-has-focused:border-primary group-has-read-write:group-hover:group-has-focused:border-primary",
			},
		},
	},
	defaultVariants: {

...
// routes/_nav.user.$userName.$typelist.($selected)/route.tsx
...
export type Info = {
  ...
  id: "routes/_nav.user.$userName.$typelist.($selected)"
  file: "routes/_nav.user.$userName.$typelist.($selected)/route.tsx"
  path: ":selected?"
  params: {"userName": string; "typelist": string; "selected"?: string}
  module: Module
